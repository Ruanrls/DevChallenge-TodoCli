...
exports.removeTasks = void 0;
var inquirer_1 = __importDefault(require("inquirer"));
var removeTasks = function (taskList) { return __awaiter(void 0, void 0, void 0, function () {
    var tasksIds;
        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, inquirer_1.default.prompt([{
                            ...
                            choices: taskList.map(function (task) {
                                return { name: task.description, value: task.id };
                            })
                        }])];
            case 1:
                tasksIds = _a.sent();
                return [2 /*return*/, tasksIds.remove];
        }
    });
}); };
